      ...
      JSXElement(path, stats) {
        ...
        for (const attribute of attributes) {
          ...
          if (t.isStringLiteral(attribute.value)) {
            (0, _resolveStringLiteral.default)(path, filenameMap[filename].styleModuleImportMap, attribute, destinationName, {
            ...
            (0, _replaceJsxExpressionContainer.default)(t, path, attribute, destinationName, filenameMap[filename].importedHelperIndentifier, filenameMap[filename].styleModuleImportMapIdentifier, {
              handleMissingStyleName
            });
          }
        }
